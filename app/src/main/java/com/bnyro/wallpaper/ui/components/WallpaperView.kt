...
fun WallpaperView(
    ...
    MultiStateDialog(state = wallpaperHelperModel.saveWallpaperState, title = "Saving Wallpaper") {
        wallpaperHelperModel.saveWallpaperState = MultiState.IDLE
    }
    MultiStateDialog(state = wallpaperHelperModel.setWallpaperState, title = "Applying Wallpaper") {
